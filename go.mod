module github.com/chengfang/custom-analyzer
...
require (
	...
	github.com/argoproj-labs/argocd-image-updater v0.16.0
...
require (
	github.com/argoproj-labs/argocd-image-updater/registry-scanner v0.1.0 // indirect
